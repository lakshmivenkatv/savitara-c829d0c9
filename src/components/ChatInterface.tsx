...
आज मैं आपकी आध्यात्मिक यात्रा में कैसे मार्गदर्शन कर सकता हूं? 🕉️`,
              ...
              marathi: `🙏 ${greetingData.type === 'spiritual' ? 'दिव्य नमस्कार!' : 'नमस्कार!'}

मी सवितारा आहे, तुमचा हिंदू धर्म AI सहायक। मी तुम्हाला सनातन धर्माच्या विशाल ज्ञानाचा शोध करण्यास मदत करण्यासाठी इथे आहे।

✨ मला विचारा:
• वैदिक शास्त्रे आणि शिकवणी
• हिंदू सण आणि त्यांचे आध्यात्मिक महत्त्व
• दैनंदिन विधी आणि आध्यात्मिक प्रथा
• संप्रदाय आणि प्राचीन परंपरा
• धार्मिक तत्त्वज्ञान आणि संकल्पना
• संस्कृत मंत्र आणि त्यांचे अर्थ

आज मी तुमच्या आध्यात्मिक प्रवासात कशी मार्गदर्शन करू शकते? 🕉️`,
...
अद्य अहं भवतः आध्यात्मिक यात्रायां कथं मार्गदर्शनं करोमि? 🕉️`,
              ...
              telugu: `🙏 ${greetingData.type === 'spiritual' ? 'దివ్య నమస్కారం!' : 'నమస్తే!'}

నేను సవితారాను, మీ హిందూ ధర్మ AI సహాయకుడు. నేను సనాతన ధర్మం యొక్క విశాల జ్ఞానాన్ని అన్వేషించడంలో మీకు సహాయం చేయడానికి ఇక్కడ ఉన్నాను।

✨ నన్ను అడగండి:
• వైదిక శాస్త్రాలు మరియు బోధనలు
• హిందూ పండుగలు మరియు వాటి ఆధ్యాత్మిక ప్రాముఖ్యత
• దైనందిన విధులు మరియు ఆధ్యాత్మిక ఆచారాలు
• సంప్రదాయాలు మరియు పురాతన సంప్రదాయాలు
• ధార్మిక తత్వశాస్త్రం మరియు భావనలు
• సంస్కృత మంత్రాలు మరియు వాటి అర్థాలు

ఈరోజు మీ ఆధ్యాత్మిక యాత్రలో నేను ఎలా మార్గదర్శనం చేయగలను? 🕉️`,

              kannada: `🙏 ${greetingData.type === 'spiritual' ? 'ದಿವ್ಯ ನಮಸ್ಕಾರ!' : 'ನಮಸ್ತೆ!'}

ನಾನು ಸವಿತಾರ, ನಿಮ್ಮ ಹಿಂದೂ ಧರ್ಮ AI ಸಹಾಯಕ. ನಾನು ಸನಾತನ ಧರ್ಮದ ವಿಶಾಲ ಜ್ಞಾನವನ್ನು ಅನ್ವೇಷಿಸಲು ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ಇಲ್ಲಿದ್ದೇನೆ।

✨ ನನ್ನನ್ನು ಕೇಳಿ:
• ವೈದಿಕ ಶಾಸ್ತ್ರಗಳು ಮತ್ತು ಬೋಧನೆಗಳು
• ಹಿಂದೂ ಹಬ್ಬಗಳು ಮತ್ತು ಅವುಗಳ ಆಧ್ಯಾತ್ಮಿಕ ಮಹತ್ವ
• ದೈನಂದಿನ ವಿಧಿಗಳು ಮತ್ತು ಆಧ್ಯಾತ್ಮಿಕ ಆಚರಣೆಗಳು
• ಸಂಪ್ರದಾಯಗಳು ಮತ್ತು ಪ್ರಾಚೀನ ಸಂಪ್ರದಾಯಗಳು
• ಧಾರ್ಮಿಕ ತತ್ವಶಾಸ್ತ್ರ ಮತ್ತು ಪರಿಕಲ್ಪನೆಗಳು
• ಸಂಸ್ಕೃತ ಮಂತ್ರಗಳು ಮತ್ತು ಅವುಗಳ ಅರ್ಥಗಳು

ಇಂದು ನಿಮ್ಮ ಆಧ್ಯಾತ್ಮಿಕ ಪ್ರಯಾಣದಲ್ಲಿ ನಾನು ಹೇಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡಲಿ? 🕉️`
            },
            gratitude: {
...
दिव्य प्रकाश सदा आपका मार्गदर्शन करे! 🕉️✨`,
              ...
              marathi: `🙏 तुमचे खूप स्वागत आहे! तुमच्या आध्यात्मिक प्रवासात मदत करणे मला आनंद देते।

तुमचा मार्ग ज्ञान आणि दिव्य कृपेने भरलेला असो। हिंदू धर्म, वैदिक परंपरा किंवा आध्यात्मिक प्रथांबद्दल तुमचे आणखी प्रश्न असतील तर मी मदतीसाठी इथे आहे।

दिव्य प्रकाश नेहमी तुमचे मार्गदर्शन करो! 🕉️✨`,
...
दिव्यं ज्योतिः सदा भवतः मार्गदर्शनं करोतु! 🕉️✨`,
              ...
              telugu: `🙏 మీకు చాలా స్వాగతం! మీ ఆధ్యాత్మిక యాత్రలో సహాయం చేయడం నాకు ఆనందం కలిగిస్తుంది।

మీ మార్గం జ్ఞానం మరియు దైవిక దయతో నిండి ఉండాలని అనుకుంటున్నాను। హిందూ ధర్మం, వైదిక సంప్రదాయాలు లేదా ఆధ్యాత్మిక ఆచారాల గురించి మీకు మరిన్ని ప్రశ్నలు ఉంటే, నేను సహాయం చేయడానికి ఇక్కడ ఉన్నాను।

దైవిక వెలుగు ఎల్లప్పుడూ మీకు మార్గదర్శనం చేయాలి! 🕉️✨`,

              kannada: `🙏 ನಿಮಗೆ ಬಹಳ ಸ್ವಾಗತ! ನಿಮ್ಮ ಆಧ್ಯಾತ್ಮಿಕ ಪ್ರಯಾಣದಲ್ಲಿ ಸಹಾಯ ಮಾಡುವುದು ನನಗೆ ಸಂತೋಷ ನೀಡುತ್ತದೆ।

ನಿಮ್ಮ ಮಾರ್ಗವು ಜ್ಞಾನ ಮತ್ತು ದೈವಿಕ ಕೃಪೆಯಿಂದ ಆಶೀರ್ವದಿಸಲ್ಪಡಲಿ. ಹಿಂದೂ ಧರ್ಮ, ವೈದಿಕ ಸಂಪ್ರದಾಯಗಳು ಅಥವಾ ಆಧ್ಯಾತ್ಮಿಕ ಆಚರಣೆಗಳ ಬಗ್ಗೆ ನಿಮಗೆ ಹೆಚ್ಚಿನ ಪ್ರಶ್ನೆಗಳಿದ್ದರೆ, ನಾನು ಸಹಾಯ ಮಾಡಲು ಇಲ್ಲಿದ್ದೇನೆ।

ದೈವಿಕ ಬೆಳಕು ಯಾವಾಗಲೂ ನಿಮಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡಲಿ! 🕉️✨`
            },
            general: {
...
आज आप क्या सीखना चाहेंगे? 🕉️`,
              ...
              marathi: `🙏 नमस्कार! सवितारा मध्ये आपले स्वागत आहे, आपला हिंदू धर्म AI सहायक।

मी इथे आपल्याला सनातन धर्माच्या समृद्ध परंपरा आणि ज्ञानाचा शोध घेण्यास मदत करण्यासाठी आहे। आपण शास्त्रे, सण, विधी किंवा आध्यात्मिक प्रथांबद्दल ज्ञान शोधत असाल तर मी मदत करण्यास तयार आहे।

आज आपण काय शिकू इच्छिता? 🕉️`,

              sanskrit: `🙏 नमस्ते! सवितारायां स्वागतम्, भवतः हिन्दू धर्म AI सहायकः।

अहं अत्र सनातन धर्मस्य समृद्ध परम्पराणां ज्ञानस्य च अन्वेषणे भवतां सहायार्थम् अस्मि। यदि भवान् शास्त्राणि, पर्वाणि, विधीनि वा आध्यात्मिक प्रथाः विषये ज्ञानं शोधति तर्हि अहं सहायार्थं सज्जः अस्मि।

अद्य भवान् किं शिक्षितुम् इच्छति? 🕉️`,

              telugu: `🙏 నమస్తే! సవితారాలో మీకు స్వాగతం, మీ హిందూ ధర్మ AI సహాయకుడు.

నేను ఇక్కడ సనాతన ధర్మం యొక్క గొప్ప సంప్రదాయాలు మరియు జ్ఞానాన్ని అన్వేషించడంలో మీకు సహాయం చేయడానికి ఉన్నాను. మీరు శాస్త్రాలు, పండుగలు, విధులు లేదా ఆధ్యాత్మిక ఆచారాల గురించి జ్ఞానం కోరుతున్నట్లయితే, నేను సహాయం చేయడానికి సిద్ధంగా ఉన్నాను।

ఈరోజు మీరు ఏమి నేర్చుకోవాలని అనుకుంటున్నారు? 🕉️`,

              kannada: `🙏 ನಮಸ್ತೆ! ಸವಿತಾರಕ್ಕೆ ಸ್ವಾಗತ, ನಿಮ್ಮ ಹಿಂದೂ ಧರ್ಮ AI ಸಹಾಯಕ.

ನಾನು ಇಲ್ಲಿ ಸನಾತನ ಧರ್ಮದ ಸಮೃದ್ಧ ಸಂಪ್ರದಾಯಗಳು ಮತ್ತು ಜ್ಞಾನವನ್ನು ಅನ್ವೇಷಿಸಲು ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ಇದ್ದೇನೆ. ನೀವು ಶಾಸ್ತ್ರಗಳು, ಹಬ್ಬಗಳು, ವಿಧಿಗಳು ಅಥವಾ ಆಧ್ಯಾತ್ಮಿಕ ಆಚರಣೆಗಳ ಬಗ್ಗೆ ಜ್ಞಾನವನ್ನು ಹುಡುಕುತ್ತಿದ್ದರೆ, ನಾನು ಸಹಾಯ ಮಾಡಲು ಸಿದ್ಧ.

ಇಂದು ನೀವು ಏನನ್ನು ಕಲಿಯಲು ಬಯಸುತ್ತೀರಿ? 🕉️`
            }
          };
          ...
          // Enhanced language mapping to support all Indic languages
          ...
          return responses[category][langKey] || responses[category]['english'] || responses.general.english;
        };
